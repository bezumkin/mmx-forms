...
$_tmp = [
    ...
    'models' => [
        'form' => [
            ...
            'help_text' => 'Вы можете использовать <a href="https://builder.vueform.com/demo?v=simple" target="_blank">Конструктор Vueform</a> для создания формы, а затем скопировать сюда готовую JSON схему.<br/><br/>' .
                'Для этого найдите кнопку "Export / Import" справа от формы, и скопируйте данные JSON.<br/><br/>' .
                ...
                'Вкладка предпросмотра активна только если получается разобрать вашу схему. Что, конечно, не гарантирует правильность этой схемы.<br/>' .
                'Необходимые разделы схемы, такие как "form", "export", "theme" и "builder" будут добавлены автоматически при сохранении, для совместимости с конструктором Vueform.'
        ],
        'submission' => [
            'title_one' => 'Отправка',
            'title_many' => 'Отправки',
            ...
            'export_placeholder' => 'Выберите форму для экспорта',
        ],
        'email' => [
            'title_one' => 'Письмо',
            'title_many' => 'Письма',
